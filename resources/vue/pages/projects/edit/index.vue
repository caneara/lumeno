<template>
    <v-layout>
        ...
        <template #content>
            ...
            <!-- Information -->
            <p class="mb-10">
                Revise a personal, educational or business project. It will be
    ...
    export default
    {
        ...
        created()
        {
            session.form = createInertiaForm({
                type         : prop('project.type'),
                logo         : prop('project.logo'),
                title        : prop('project.title'),
                summary      : prop('project.summary'),
                url          : prop('project.url'),
                first_tag    : prop('project.first_tag'),
                second_tag   : prop('project.second_tag'),
                third_tag    : prop('project.third_tag'),
                fourth_tag   : prop('project.fourth_tag'),
                first_image  : prop('project.first_image'),
                second_image : prop('project.second_image'),
                third_image  : prop('project.third_image'),
                uploading    : false,
            }, 'edit');
        },
    }
